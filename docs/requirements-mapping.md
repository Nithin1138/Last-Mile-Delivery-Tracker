...
| **Notification Provider Abstraction (Email & SMS)** | [`backend/app/services/notification_service.py`](../backend/app/services/notification_service.py) | Internal service (Resend + Console + Extensible) | `tests/test_notifications.py` (6 tests) | `OrderDetailModal.tsx` |
