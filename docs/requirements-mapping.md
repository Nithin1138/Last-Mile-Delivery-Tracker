...
| **Transactional Email Provider Abstraction** | [`backend/app/services/notification_service.py`](../backend/app/services/notification_service.py) | Internal service (Resend + Console) | `tests/test_notifications.py` (6 tests) | `OrderDetailModal.tsx` |
